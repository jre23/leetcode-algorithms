...
var threeSum = function (nums) {
  ...
  if (nums.length < 3) {
    ...
    for (let i = 0; i < nums.length - 2; i++) {
      ...
      let k = nums.length - 1;
      while (j < k) {
        let testSum = nums[i] + nums[j] + nums[k];
        let testArray = [nums[i], nums[j], nums[k]];
        if (testSum === 0) {
          results.push(testArray);
...
let nums0 = [-1, 0, 1, 2, -1, -4]; // expected [[-1, -1, 2], [-1, 0, 1]]
let nums1 = [0, 0, 0, 0]; // expected [[0, 0, 0]]
let nums2 = [-1, 0, 1, 0]; // expected [[-1, 0, 1]]
let nums3 = [-2, 0, 1, 1, 2]; // expected [[-2,0,2],[-2,1,1]]
let nums4 = [
  82597,
  -9243,
  62390,
...
//   (k === nums.length - 1 && i < nums.length - 3)
// ) {
//   // console.log(i, "i");
//   // console.log(j, "j");
//   // console.log(k, "k");
...
//         testSum === 0 &&
//         !results.some(
//           (item) => JSON.stringify(item) === JSON.stringify(testArray)
//         )
//       ) {
//         results.push(testArray);
//       }
...
// this else if and return statement was giving me a runtime error when submitting
// } else if (nums.length === 3 && nums[0] + nums[1] + nums[2] === 0) {
// return [nums[0], nums[1], nums[2]];
// Line 59 in solution.js
//              throw new TypeError(__serialize__(ret) + " is not valid value for the expected return type list<list<integer>>");
//              ^
// TypeError: [0,0,0] is not valid value for the expected return type list<list<integer>>
//     Line 59: Char 20 in solution.js (Object.<anonymous>)
//     Line 16: Char 8 in runner.js (Object.runner)
//     Line 45: Char 26 in solution.js (Object.<anonymous>)
